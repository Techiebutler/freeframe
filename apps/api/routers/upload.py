...
def initiate_upload(
    ...
    file_type_map = {AssetType.image: FileType.image, AssetType.audio: FileType.audio, AssetType.video: FileType.video, AssetType.image_carousel: FileType.image, AssetType.document: FileType.document}
